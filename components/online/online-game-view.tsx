				...
				<div className="mb-8">
					...
					<div className="space-y-2">
						{game.players.map((player, index) => (
							<div key={player.id} className="flex items-center justify-between rounded-lg border border-border bg-card px-4 py-3">
			...
			<div className="flex-1 px-4 py-6 max-w-lg mx-auto w-full">
				...
				<div
					className={`rounded-xl p-4 mb-6 border ${
						roleRevealed ? (isImpostor ? "border-primary/30 bg-primary/5" : "border-success/30 bg-success/5") : "border-border bg-card"
					}`}>
